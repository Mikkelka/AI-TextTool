<template>
  <div class="onboarding-window" @keydown="handleKeydown" tabindex="0">
    <!-- Header -->
    ...
    <div v-else class="onboarding-content">
      ...
      <div v-if="currentStep === 1" class="setup-step">
        ...
        <div class="api-key-help">
          <button @click="openApiKeyUrl" class="help-button">
      ...
      <div v-if="currentStep === 2" class="setup-step">
        ...
        <div class="form-group">
          <label for="system-instruction" class="form-label">
            System Instruction
          </label>
          <textarea
          ...
          <div class="test-item">
            <div class="test-info">
              ...
              <div class="test-details">
                ...
                <div class="test-status">
                  {{ 
                    testResults.connection === 'testing' ? 'Testing...' :
                    testResults.connection ? 'Connected' : 'Failed to connect'
                  }}
                </div>
              </div>
            </div>
...
const formData = ref({
  apiKey: '',
  systemInstruction: 'You are a helpful, friendly AI assistant. Provide clear and accurate assistance with text processing tasks.'
})
...
const instructionPresets = {
  default: 'You are a helpful, friendly AI assistant. Provide clear and accurate assistance with text processing tasks.',
  concise: 'You are a concise AI assistant. Provide direct, brief responses without unnecessary elaboration while maintaining accuracy.',
  professional: 'You are a professional AI writing assistant. Provide polished, formal responses with attention to detail and proper formatting.'
}
...
const openApiKeyUrl = async () => {
  try {
    ...
    error.value = 'Failed to open browser. Please visit https://aistudio.google.com/app/apikey manually.'
  }
}
